...
<span class="line"></span></code></pre></div><p>主要是要改四个地方：</p><ol><li>do_faccessat，通常位于 <code>fs/open.c</code></li><li>do_execveat_common，通常位于 <code>fs/exec.</code></li><li>vfs_read，通常位于 <code>fs/read_write.c</code></li><li>vfs_statx，通常位于 <code>fs/stat.c</code></li></ol><p>改完之后，打开 <code>KernelSU/kernel/ksu.c</code>，注释 <code>enable_sucompat()</code>调用，然后重新编译内核即可。</p>`,24),o=[p];function t(c,r,i,C,A,D){return a(),n("div",null,o)}const f=s(e,[["render",t]]);export{y as __pageData,f as default};
