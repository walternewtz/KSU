...
<span class="line"></span></code></pre></div><p>对于早于 4.17 的内核，如果没有 <code>do_faccessat</code>，可以直接找到 <code>faccessat</code> 系统调用的定义然后修改：</p><div class="language-diff"><button title="Copy Code" class="copy"></button><span class="lang">diff</span><pre class="shiki material-palenight has-diff"><code><span class="line"><span style="color:#A6ACCD;">diff --git a/fs/open.c b/fs/open.c</span></span>
...
<span class="line"><span style="color:#A6ACCD;"> 		return -EINVAL;</span></span>
<span class="line"></span></code></pre></div><p>改完之后重新编译内核即可。</p>`,29),o=[e];function t(c,r,i,C,A,D){return n(),a("div",null,o)}const f=s(p,[["render",t]]);export{y as __pageData,f as default};
